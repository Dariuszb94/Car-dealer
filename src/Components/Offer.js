            ...
            <section className="carOffer">
              <article className="imagesContainer">
                <div className="choosenBigPicture">
                  <img id="picture1" className="offerImageBigPicture " alt={this.props.cars.cars[this.props.id.id].image1} src={require(`../Assets/${this.props.cars.cars[this.props.id.id].image1}.jpg`)}/>
                  <img id="picture2" className="offerImageBigPicture" alt={this.props.cars.cars[this.props.id.id].image2} src={require(`../Assets/${this.props.cars.cars[this.props.id.id].image2}.jpg`)}/>
                  <img id="picture3" className="offerImageBigPicture" alt={this.props.cars.cars[this.props.id.id].image3} src={require(`../Assets/${this.props.cars.cars[this.props.id.id].image3}.jpg`)}/>
                </div>
                <div className="smallPictures">
                  <img className="offerImageSmallPicture" alt={this.props.cars.cars[this.props.id.id].image1} src={require(`../Assets/${this.props.cars.cars[this.props.id.id].image1}.jpg`)} onClick={this.chooseFirstPicture}/>
                  <img className="offerImageSmallPicture" alt={this.props.cars.cars[this.props.id.id].image2} src={require(`../Assets/${this.props.cars.cars[this.props.id.id].image2}.jpg`)} onClick={this.chooseSecondPicture}/>
                  <img className="offerImageSmallPicture" alt={this.props.cars.cars[this.props.id.id].image3} src={require(`../Assets/${this.props.cars.cars[this.props.id.id].image3}.jpg`)} onClick={this.chooseThirdPicture}/>
                </div>
              </article>
              <article className="textContainer">
                <div className="carNameAndPrice">
                  <div className="carName">
                    <h2>{this.props.cars.cars[this.props.id.id].brand} {this.props.cars.cars[this.props.id.id].model}</h2>
                  </div>
                  <div className="carPrice">
                    <h2>{this.props.cars.cars[this.props.id.id].price}</h2>
                    </div>
                  </div>
